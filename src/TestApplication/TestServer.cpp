...
namespace ItSoftware::CppIncludeLinux::TestServer
{
    //
    // using
    //
...
//
// (i): Application entry point.
//      Redirects main to ItSoftware::CppIncludeLinux::TestServer::main.
//
int main(int argc, const char* argv[])
{
    return ItSoftware::CppIncludeLinux::TestServer::main(argc, argv);
}